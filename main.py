...
def codegen(data):
    if isinstance(data[0], list):
        print(f"SyntaxError: I don't even know how you got this error, but the AST returned an array as the first keyword. This was at line {currentline}")
    pre, bss, out, = [], [], [], [], []
    global vartype, links, mainfn, libs, scope, fncs, externs
    linecount = len(data)
    i = 0
    while i < linecount:
        line = data[i]
